...
//	}
//}
//void Print_Even_Nodes(circular_list& list) {
//	int position_count = 1;
//	Node* p = list.get_head();
...
//	}
//}
//int Number_of_Nodes(circular_list& list) {
//	if (list.isEmpty())
//	{
...
//}
//void Display_headTail(const circular_list & list) {
//	if (!list.isEmpty())
...
//cout << "List 1:\n";
//cout << "\nList 2:\n";
//mylist2.insert_end(5);
//mylist2.insert_end(6);
//mylist2.insert_end(7);
//mylist2.Display_list();
//ans = mylist.concatenate(mylist2);
